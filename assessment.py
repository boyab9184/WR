...
while True:  
    ...
    if user_choice == 1:
       ...
       print ('\nThis is: ',are_all_client_ids_unique(data_frame))
        ...
        number = int(input("Enter your NUMBER:")) 
        print ("\nTotal revenue generated by all clients with less than %d sessions: $" %(number), "{:.2f}".format(revenue_with_less_than_num_sesions(data_frame, number)))
        ...
        number = int(input("Enter your NUMBER:")) 
        print ("\nRevenue generated by the %d client ids with the most transactions: $" %(number), "{:.2f}".format (revenue_with_most_transaction_limited(data_frame, number)))

    elif user_choice == 6:
        number = int(input("Enter your NUMBER:")) 
        print ("\nAggregated average session duration generated by the %d client ids with the most transactions: " %(number), avarage_session_duration(data_frame, number))
