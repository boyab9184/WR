...
while True:  
    ...
    if user_choice == 1:
       print ('\nThis is: ', ast.are_all_client_ids_unique(ast.data_frame))
        ...
        number = int(input("Enter your NUMBER:")) 
        print ("\nTotal revenue generated by all clients with less than %d sessions: $%.2f" %(number, ast.revenue_with_less_than_num_sesions(ast.data_frame, number)))
        ...
        number = int(input("Enter your NUMBER:")) 
        print ("\nRevenue generated by the %d client ids with the most transactions: $%.2f" %(number, ast.revenue_with_most_transaction_limited(ast.data_frame, number)))
        ...
        number = int(input("Enter your NUMBER:")) 
        print ("\nAggregated average bounce rate in generated by the %d client ids with the most transactions: %.2f%%" %(number, ast.avarage_bounce_rate(ast.data_frame, number)))
